    ...
    return (
      <div className="max-w-xs h-[450px] w-[330px] rounded-3xl overflow-hidden shadow-lg text-center font-sans">
        <div className="bg-blue-500 h-[160px] flex items-center justify-center relative">
          ...
          <img
          className="w-[159px] h-[159px] rounded-full object-cover mb-4 absolute -bottom-7"
          src={profileImage}
          alt={`${name}'s profile`}
          />
        </div>
        <div className="bg-gray-100 h-[290px] p-4">
              <div className="flex items-center justify-center mb-2">
              <h2 className="text-[25px] font-bold text-gray-800">{name}</h2>
        {isAdmin && (
          <FaUserShield className="text-blue-500 ml-2" title="Admin" size={20} />
        )}
      </div>
          ...
          <div className="p-4">
            <button className="bg-blue-500 text-[20px] rounded-[12px] text-white py-2 px-4 rounded hover:bg-blue-700 w-[195px] h-[46px]">
              View Profile
            </button>
          </div>
        </div>
